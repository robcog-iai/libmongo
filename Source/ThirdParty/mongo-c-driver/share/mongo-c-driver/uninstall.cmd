...
REM Mongo C Driver uninstall program, generated on 07.01.2019 14:57:10,47
...
pushd C:\mongo-c-driver-no-align\
...
cd ..
echo Removing top-level installation directory: C:\mongo-c-driver-no-align\
(rmdir C:\mongo-c-driver-no-align\ 2>NUL) || echo ... not removed (probably not empty)
